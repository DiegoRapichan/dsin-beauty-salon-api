      ...
      <div className="w-full max-w-[400px]">
        <header className="text-center mb-10">
          <h2 className="text-3xl font-black italic tracking-tighter uppercase">
            CRIE SUA <span className="text-cyan-500">CONTA</span>
          </h2>
        ...
        >
          <div className="space-y-6">
            <div>
              ...
              <input
                type="text"
                className="w-full bg-black border border-white/10 p-5 rounded-2xl outline-none focus:border-cyan-500 transition-all"
                value={nome}
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-cyan-600 py-5 rounded-2xl font-black uppercase tracking-widest shadow-xl shadow-cyan-900/20 active:scale-95 transition-all"
            >
            ...
            <button
              type="button"
              onClick={() => navigate("/")}
              className="w-full text-[10px] text-gray-600 font-bold uppercase tracking-widest mt-4"
            >
              Já tenho conta
            </button>
          </div>
