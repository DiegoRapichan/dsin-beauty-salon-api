...
export default function LoginAdmin() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-black text-white font-sans selection:bg-pink-500/30">
      <div className="mb-12 text-center">
        <h1 className="text-5xl font-black italic tracking-tighter leading-none text-white">
          LEILA <span className="text-pink-500 not-italic">SALON</span>
        </h1>
        ...
        <div className="space-y-6">
          <div className="flex flex-col gap-2">
            ...
            <input
              ...
              className="w-full bg-black p-4 rounded-2xl border border-gray-800 focus:border-pink-500 outline-none text-white transition-all placeholder:text-gray-800"
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-pink-600 hover:bg-pink-500 disabled:bg-gray-800 py-5 rounded-2xl font-black uppercase tracking-[0.2em] transition-all shadow-xl shadow-pink-900/20 active:scale-95 text-xs mt-4"
          >
